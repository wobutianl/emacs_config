(setq default-directory "D:/Program Files/CodeBlocks/MinGW/bin")
;;===================================
;;设置编译器==========================
;;===================================
;;(setq compile-command (concat "D:/Program Files/CodeBlocks/MinGW/bin/g++ -g " "/"" buffer-file-name "/"")) 
    ...
    (if (not (null
        ...
        (if (null (buffer-file-name (current-buffer)))
            ...
            (if (eq major-mode 'c-mode)
                (setq command
                      (concat "D:/Program Files/CodeBlocks/MinGW/bin/gcc.exe -Wall -o "      ;;你要明确知道自己的编译器在
哪里,
...
和vista的习惯相反,你要注意修改
              ...
              (if (eq major-mode 'c++-mode)
                  (setq command
                        (concat "D:/Program Files/CodeBlocks/MinGW/bin/g++.exe -Wall -o " ;;还有这里的g++,也同gcc一样...
